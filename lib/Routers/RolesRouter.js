...
var RolesRouter = exports.RolesRouter = function (_ClassesRouter) {
  ...
  _createClass(RolesRouter, [{
    ...
    value: function getExpressRouter() {
      ...
      router.route('GET', '/roles', function (req) {
        return _this2.handleFind(req);
      });
      router.route('GET', '/roles/:objectId', function (req) {
        return _this2.handleGet(req);
      });
      router.route('POST', '/roles', function (req) {
        return _this2.handleCreate(req);
      });
      router.route('PUT', '/roles/:objectId', function (req) {
        return _this2.handleUpdate(req);
      });
      router.route('DELETE', '/roles/:objectId', function (req) {

...
var InstallationsRouter = exports.InstallationsRouter = function (_ClassesRouter) {
  ...
  _createClass(InstallationsRouter, [{
    ...
    value: function getExpressRouter() {
      ...
      router.route('GET', '/installations', function (req) {
        return _this2.handleFind(req);
      });
      router.route('GET', '/installations/:objectId', function (req) {
        return _this2.handleGet(req);
      });
      router.route('POST', '/installations', function (req) {
        return _this2.handleCreate(req);
      });
      router.route('PUT', '/installations/:objectId', function (req) {
        return _this2.handleUpdate(req);
      });
      router.route('DELETE', '/installations/:objectId', function (req) {

...
var SessionsRouter = exports.SessionsRouter = function (_ClassesRouter) {
  ...
  _createClass(SessionsRouter, [{
    ...
    value: function getExpressRouter() {
      ...
      router.route('GET', '/sessions/me', function (req) {
        return _this2.handleMe(req);
      });
      router.route('GET', '/sessions', function (req) {
        return _this2.handleFind(req);
      });
      router.route('GET', '/sessions/:objectId', function (req) {
        return _this2.handleGet(req);
      });
      router.route('POST', '/sessions', function (req) {
        return _this2.handleCreate(req);
      });
      router.route('PUT', '/sessions/:objectId', function (req) {
        return _this2.handleUpdate(req);
      });
      router.route('DELETE', '/sessions/:objectId', function (req) {

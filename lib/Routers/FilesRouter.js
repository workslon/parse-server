...
var FilesRouter = exports.FilesRouter = function () {
  ...
  _createClass(FilesRouter, [{
    ...
    key: 'getHandler',
    value: function getHandler(req, res, next) {
    ...
    value: function createHandler(req, res, next) {
      ...
      var filename = req.params.filename + extension;
      var config = req.config;
      var filesController = config.filesController;

      filesController.createFile(config, filename, req.body).then(function (result) {
        res.status(201);
